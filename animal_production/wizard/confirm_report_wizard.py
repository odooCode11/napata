...
class ConfirmReportWizard(models.TransientModel):
    _name = 'confirm.report.wizard'
    _description = 'Confirm Report'
    ...
    def get_report(self):
        ...
        return self.env.ref('animal_production.confirm_report').report_action(self, data=data)


class ConfirmReport(models.AbstractModel):
    _name = 'report.animal_production.confirm_template'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if params == 'general':
            docs = self.env['permission'].search([])
        ...
        docs = self.env['permission'].search(domain)
