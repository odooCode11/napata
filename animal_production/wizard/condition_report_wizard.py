...
class ConditionReportWizard(models.TransientModel):
    _name = 'condition.report.wizard'
    _description = 'Condition Report'
    ...
    def get_report(self):
        ...
        return self.env.ref('animal_production.condition_report').report_action(self, data=data)


class ConditionReport(models.AbstractModel):
    _name = 'report.animal_production.condition_template'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if params == 'period_only':
            docs = self.env['conditions'].search([])
        ...
        docs = self.env['conditions'].search(domain)
